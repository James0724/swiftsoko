          ...
          >
            ...
            >
              <div className="bg-gray-50 border-b border-gray-200">
                ...
                <Link
                  href={`/products?category=${cat.slug}`}
                  className="flex items-center justify-between pl-10 pr-5 py-2 text-[10px] font-black uppercase tracking-wide text-indigo-600 hover:bg-indigo-50 transition-colors duration-150"
                >
                  All {cat.name} <ArrowRight className="w-3 h-3" />
                </Link>
              </div>
            </div>
          </div>
